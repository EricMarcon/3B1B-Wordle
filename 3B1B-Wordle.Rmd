...
The derivation of \ref(eq:partition) is detailed here, step by step.
Each line of the code contains the total entropy, starting from $\alpha$ plus $\beta$ entropy as defined before.
